...
![p4](http://www.plantuml.com/plantuml/proxy?idx=0&src=https://raw.githubusercontent.com/Parofeen/Parfenova_ST/main/file/4.txt)
...
![p5](http://www.plantuml.com/plantuml/proxy?idx=0&src=https://raw.githubusercontent.com/Parofeen/Parfenova_ST/main/file/5.txt)
...
![p6](http://www.plantuml.com/plantuml/proxy?idx=0&src=https://raw.githubusercontent.com/Parofeen/Parfenova_ST/main/file/6.txt)
...
![p7](http://www.plantuml.com/plantuml/proxy?idx=0&src=https://raw.githubusercontent.com/Parofeen/Parfenova_ST/main/file/7.txt)

### 8. Демонстрация реализации (личная страница)

Ссылка на личную страницу [GitHub](https://github.com/Parofeen/Parfenova_ST)
...
Цель моделирования - определение автоматизируемых функций. Автоматизация функций измеряется в функциональных точках, соответственно, числовым показателем для поставленной цели моделирования является количество функциональных точек, которые извлекаются из DFD:

![](https://github.com/Parofeen/Parfenova_ST/blob/main/file/tab1.jpg)
...
Среди всех показателей, одними из важных являются время и трудозатраты на выполнение процесса

**10.3 Расчет потенциального эффекта от автоматизации:**

Автоматизация функций необходима в первую очередь для того, чтобы защита от атак работала в фоновом режиме без необходимости участия сотрудника.
Это достигается с помощью использования планировщика задач, который запускает скрипты с определенной периодичностью.
Таким образом сотруднику нужно вмешиваться только в крайних случаях.

**10.4 Определение числовых показателей и расчет затрат на реализацию проекта автоматизации:**

Расчет сложности разработки методом FPA IFPUG:

![](https://github.com/Parofeen/Parfenova_ST/blob/main/file/tab2.jpg)

Расчет трудозатрат на разработку «с нуля» методом COCOMO II:

![](https://github.com/Parofeen/Parfenova_ST/blob/main/file/tab3.jpg)
...
![](https://github.com/Parofeen/Parfenova_ST/blob/main/file/tab4.jpg)

**ВЫВОДЫ**

Исходя из результатов таблицы п.10.5 можно сделать вывод, что за счет сокращения функциональных требований удалось сократить строки кода в 3,14 раз. 
Также за счет сокращения документации и объема испытаний, удалось сократить срок разработки с 9,8 месяцев до 8. 
Срок окупаемости разработки сократился в 4,28 раз. 
На данный момент работа выполнена на 80%.
