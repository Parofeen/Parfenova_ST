...
Автоматизация функций измеряется в функциональных точках, соответственно, числовым показателем для поставленной цели моделирования является количество функциональных точек, которые извлекаются из DFD:
