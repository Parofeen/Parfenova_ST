...
**4.1 Идентификатор прецедента:** А11

**4.2 Название прецедента:** Контроль загруженности ресурсов системы

**4.3 Контекст:** А1 Обеспечение защиты от DoS/DDoS-атак

**4.4 Участники (actors) и цели (goals):**

| Участник  | Категория  | Цель (goal) |
|---|---|---|
| Сотрудник инф. безопасности | Основной  | Контроль работы системы |
| Средства обеспечения защиты | Инструмент| Проверка загруженности ресурсов системы |

**4.5 Предусловия (pre-conditions):**

* Исправность оборудования <условие наличия потока управления>

* Запрос пользователя <условие наличия входного потока>

* Аппаратные возможности системы <условие наличия потока исполнителя>

* <условие наличия потока механизма>

**4.6 Постусловия (post-conditions):**

* Информация о загруженности системы <выходной поток>

**4.7 Основной поток выполнения (main flow)**:

| Участник  | Действие (activity)  | Ожидаемый результат |
|---|---|---|
| Сотрудник инф. безопасности | Контроль ресурсов системы | Информация о корректной работе |
...
* **Триггер (событие, стартующее прецедент):** Проверка загруженности ресурсов <управляющий поток>

* **Номинальная частота повторения прецедента:** Каждые 30 минут <n раз в смену/сутки/месяц/квартал/год...>

* **Продолжительность прецедента:** 1 минута <n нормочасов>
